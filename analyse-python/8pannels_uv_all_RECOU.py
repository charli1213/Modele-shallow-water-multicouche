...
for step in step_array : 
    ...
    # --- Plotting
    (10**-VSci[0]*Ueff.isel(time=-1)).plot(ax=ax0,cmap='RdBu',
    ...
    (10**-VSci[4]*Veff.isel(time=-1)).plot(ax=ax4,cmap='RdBu',
    ...
    plt.tight_layout()
    plt.savefig('8pannels_UV_RECOU_step{}.png'.format(step))
    #plt.show()
    plt.close()
