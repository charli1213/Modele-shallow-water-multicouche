...
pathnames = [['RESTARTCHEN_5y_tau0.09_512_step0.0','tab:orange'],
             ['RESTARTCHEN_5y_tau0.09_512_step1.0','tab:orange'],             
             ['RECOU7_np38_tau0.10_step0.0','tab:blue'],
             ['RECOU7_np38_tau0.10_step1.0','tab:blue']]
...
datapath = '/line_output/line_div_ek'
...
for name in pathnames :
    dataset_wek = open_line_otput(basepath+name[0]+'/line_output/line_div_ek')
    dataset_u1 = open_line_otput(basepath+name[0]+'/line_output/line_u1')
    dataset_v1 = open_line_otput(basepath+name[0]+'/line_output/line_v1')
    dataset_u2 = open_line_otput(basepath+name[0]+'/line_output/line_u2')
    dataset_v2 = open_line_otput(basepath+name[0]+'/line_output/line_v2')
