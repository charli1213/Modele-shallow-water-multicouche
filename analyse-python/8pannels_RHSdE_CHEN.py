...
for step in step_list :  
    path = basepath+'RESTARTCHEN_5y_tau0.09_512_step{}//data/'.format(step)
    ...
    Uek = ds.Uek
    Vek = ds.Vek
    Uef = Uek # Courant qui multiplie pour avoir l'énergie.
    Vef = Vek
    zeta_ek = ds.zeta_ek
    zeta1   = ds.zeta1
    ...
    for qty in Quantities : 
        ...
        plt.tight_layout()
        plt.savefig('CHEN_dEnRHSof{}_step{}.png'.format(qty,step))
        plt.close()
